...
public class Truck extends Thread {
    ...
    private static final int UNLOADING_TIME = 40;
    ...
    @Override
    public void run() {
        UnloadingPlace unloading = UnloadingPlace.getUnloadingPlace();
        ...
        try {
            ...
            Ramp ramp = unloading.getRamp(this);
            unloadGoods();
            unloading.releaseRamp(this, ramp);
    ...
    private void unloadGoods() throws InterruptedException {
        TimeUnit.MILLISECONDS.sleep(UNLOADING_TIME);
